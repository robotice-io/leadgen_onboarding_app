  ...
  return (
    <I18nProvider>
      <div className="min-h-screen w-full bg-[linear-gradient(180deg,rgba(2,6,23,0)_0%,rgba(2,6,23,0)_60%,rgba(2,6,23,0.03)_100%)]">
        <TopBar />
        <div className={`mx-auto w-full max-w-5xl px-4 sm:px-6 md:px-8 mt-[30px] py-6 sm:py-10 bg-[radial-gradient(ellipse_at_20%_0%,rgba(59,130,246,0.10)_0%,transparent_40%),radial-gradient(ellipse_at_80%_100%,rgba(59,130,246,0.08)_0%,transparent_45%)] rounded-xl` }>
          <Wizard />
        </div>
      </div>
    </I18nProvider>
