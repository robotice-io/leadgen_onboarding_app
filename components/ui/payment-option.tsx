...
const PaymentRadio: React.FC<PaymentRadioProps> = ({
  ...
  return (
    <div className={`w-full max-w-xl space-y-2 dark:bg-neutral-900 p-4 shadow-xl border border-white/10 rounded-2xl bg-neutral-100 dark:bg-black/30 ${className}`}>
      <div className="mb-2">
